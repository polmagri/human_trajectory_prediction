...
color_path = 'dataset/test1/rgb'
depth_path = 'dataset/test1/depth'
camera_csv_path = 'dataset/test1/camera_coord.csv'
global_csv_path = 'dataset/test1/global_coord.csv'
